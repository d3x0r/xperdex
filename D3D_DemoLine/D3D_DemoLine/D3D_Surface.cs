	...
	class D3D_Surface
	{
		...
		public D3D_Surface()
		{
			...
			try
			{
				...
				DX_Device = new Device( 0, DeviceType.Hardware
		   , this, CreateFlags.SoftwareVertexProcessing, pps ); // Put everything into the device
				return true;
			}
		...
		public class PSI_DirectFrame
		{
			...
			{
				Control c = new UserControl();
				c.Location  = new Point( 0, 0 );
				c.Size = new Size( screenwidth, screenheight );
