...
using Direct3D = Microsoft.WindowsMobile.DirectX.Direct3D;
//using DirectSound = Microsoft.WindowsMobile.DirectX.DirectX.DirectSound;
...
namespace PullPosition
{
	...
	public class PSI_DirectFrame //: IReflectorCanvas, IReflectorWidget
	{
		...
		public PSI_DirectFrame( Control control )
		{
