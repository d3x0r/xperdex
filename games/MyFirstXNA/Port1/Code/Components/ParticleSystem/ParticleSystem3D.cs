...
namespace TestsForFun
{
    ...
    /// </summary>
    public abstract class ParticleSystem3D : DrawableGameComponent
    {
        #region Fields
        ...
        void LoadParticleEffect()
        {
            ...
            effectVelocityParameter = parameters["ConstantVelocity"];
            effectLightBrightnessParameter = parameters["LightBrightness"];
        ...
        /// </summary>
        public virtual void Draw(GameTime gameTime, Light SceneLight)
        {
            //particleEffect.Parameters["LightColor"].SetValue(settings.particleColor.ToVector4());
        ...
        /// </summary>
        public void AddParticle(Vector3 position, Vector3 velocity, Color particleColor)
        {
            ...
            particles[firstFreeParticle].LightColor = particleColor;
        ...
        public void AddParticle(Vector3 position, Vector3 velocity)
        {
            ...
            particles[firstFreeParticle].Random = randomValues;
            particles[firstFreeParticle].Time = currentTime;
            particles[firstFreeParticle].LightColor = Color.White;
