...
float4 ComputeParticleColor(float4 projectedPosition,
                            float randomValue, float normalizedAge, float4 LightColor)
{
...
#endif
	color.rgb *= LightColor * LightBrightness;
...
VertexShaderOutput VertexShader(VertexShaderInput input)
{
    ...
    output.Color = ComputeParticleColor(output.Position, input.Random.z, normalizedAge, input.LightColor);
