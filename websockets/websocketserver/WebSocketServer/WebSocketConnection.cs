...
namespace WebSocketServer
{
    ...
    public class WebSocketConnection : IDisposable
    {
		 ...
		 */
		//There is one Web Socket header whose name is "websocket-origin" and 
		//  whose value exactly equals /origin/. 
		private string webSocketOrigin;     // location for the protocol handshake
		//There is one Web Socket header whose name is "websocket-location" and whose 
		// value exactly equals a Web Socket URL constructed as described 
		// above in Section 3.2 using /host/, /port/, /resource name/, and /secure/.
