...
namespace CUIC.ReceiptBrowser
{
    ...
    public sealed class Interop {
        ...
        [DllImport("urlmon.dll", ExactSpelling=true, CharSet=CharSet.Unicode)]
        internal static extern int CoInternetCombineUrl(
        ...
        [ComVisible(false)]
            ...
            public ConnectionPointCookie(object source, object sink, Type eventInterface, bool throwException) {
                Exception ex = null;
                if (source is System.Runtime.InteropServices.ComTypes.IConnectionPointContainer) {
                    System.Runtime.InteropServices.ComTypes.IConnectionPointContainer cpc = (System.Runtime.InteropServices.ComTypes.IConnectionPointContainer)source;
        ...
        [ComVisible(true), ComImport(), Guid("BD3F23C0-D43E-11CF-893B-00AA00BDCE1A"), InterfaceTypeAttribute(ComInterfaceType.InterfaceIsIUnknown)]
            ...
            [PreserveSig]
            int ResizeBorder(
                [In] Interop.COMRECT rect,
                [In] Interop.IOleInPlaceUIWindow doc,
            ...
            int FilterDataObject(
                [In, MarshalAs(UnmanagedType.Interface)]   Interop.IOleDataObject pDO,
                [Out, MarshalAs(UnmanagedType.Interface)] out Interop.IOleDataObject ppDORet);
        }
        ...
        [ComVisible(true), Guid("79eac9e4-baf9-11ce-8c82-00aa004ba90b"), InterfaceTypeAttribute(ComInterfaceType.InterfaceIsIUnknown)]
            ...
            int Start(
                ...
                string szUrl,
                [In]
                IInternetProtocolSink protocolSink,
                [In]
                IntPtr bindInfo,
                [In]
                int grfPI,
        ...
        [ComVisible(true), Guid("79eac9ec-baf9-11ce-8c82-00aa004ba90b"), InterfaceTypeAttribute(ComInterfaceType.InterfaceIsIUnknown)]
        ...
        [ComVisible(true), Guid("79eac9e5-baf9-11ce-8c82-00aa004ba90b"), InterfaceTypeAttribute(ComInterfaceType.InterfaceIsIUnknown)]
        ...
        [ComVisible(true), Guid("0000000F-0000-0000-C000-000000000046"), InterfaceTypeAttribute(ComInterfaceType.InterfaceIsIUnknown)]
            ...
            System.Runtime.InteropServices.ComTypes.FILETIME GetTimeOfLastChange(
                [In, MarshalAs(UnmanagedType.Interface)]
                object pbc,
                [In, MarshalAs(UnmanagedType.Interface)]
                IMoniker pMkToLeft);
