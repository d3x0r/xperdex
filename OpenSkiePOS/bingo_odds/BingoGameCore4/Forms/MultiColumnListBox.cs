...
namespace BingoGameCore4.Forms
{
    public class MultiColumnListBox : ListBox
    {
        ...
        //        {
        //            Pen pen = new Pen( new SolidBrush( e.BackColor ) );
        ...
        protected override void OnKeyPress( KeyPressEventArgs e )
        {
            ...
            switch( matchEntryStyle )
            {
                ...
                case MatchEntryStyle.CompleteSensitive:
                    ...
                    break;
                case MatchEntryStyle.CompleteBestMatch:
                    MatchBuffer += e.KeyChar.ToString();
...
#region DrawSubItem, MeasureSubItem EventArgs and EventHandlers defn
    ...
    public class DrawSubItemEventArgs : DrawItemEventArgs
    {
        ...
        public DrawSubItemEventArgs(Graphics graphics,Font font,Rectangle rect,int index,int subIndex,PropertyDescriptor boundProperty,DrawItemState state) : base(graphics,font,rect,index,state)
        {
    ...
    public class MeasureSubItemEventArgs : MeasureItemEventArgs
    {
        ...
        public MeasureSubItemEventArgs(Graphics g,int index, int subIndex) : base(g,index)
        {
            this.subIndex = subIndex;
        }

        public MeasureSubItemEventArgs(Graphics g,int index, int subIndex, int itemHeight) : base(g,index,itemHeight)
        {
            this.subIndex = subIndex;
        }
    }
