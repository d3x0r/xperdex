...
namespace PrizeScheduleEditor
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
			...
			//this.currentGameGroupList1 = new OpenSkieScheduler.Controls.Lists.CurrentGameGroupGameList();
			...
			//this.editGameGroupGame1 = new OpenSkieScheduler.Controls.Buttons.EditPackGroupGame();
			...
			this.gameGroupList1.DisplayMember = "game_group_name";
        ...
        230};
			...
			this.enableEdit1.Size = new System.Drawing.Size( 82, 17 );
			this.enableEdit1.TabIndex = 19;
			this.enableEdit1.Text = "enableEdit1";
			...
			this.label5.Text = "Daily Sessions(SessionName)";
			// 
			// label6
			// 
		...
		//private OpenSkieScheduler.Controls.Lists.CurrentPackGameList currentGameGroupList1;
		...
		//private OpenSkieScheduler.Controls.Buttons.EditGameGroupGame editGameGroupGame1;
