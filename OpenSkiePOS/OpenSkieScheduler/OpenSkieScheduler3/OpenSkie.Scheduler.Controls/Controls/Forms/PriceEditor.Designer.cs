namespace OpenSkieScheduler3.Controls.Forms
{
	partial class PriceEditor
	{
		...
		private void InitializeComponent()
		{
			...
			this.radioButtonPriceIncrement = new System.Windows.Forms.RadioButton();
			this.textBoxPriceIncrement = new System.Windows.Forms.TextBox();
			this.radioButtonPriceMultiplier = new System.Windows.Forms.RadioButton();
			...
			this.groupBox3.Controls.Add( this.radioButtonPriceIncrement );
			this.groupBox3.Controls.Add( this.textBoxPriceIncrement );
			this.groupBox3.Controls.Add( this.radioButtonPriceMultiplier );
			...
			// 
			// radioButtonPriceIncrement
			// 
			this.radioButtonPriceIncrement.AutoSize = true;
			this.radioButtonPriceIncrement.Location = new System.Drawing.Point( 119, 12 );
			this.radioButtonPriceIncrement.Name = "radioButtonPriceIncrement";
			this.radioButtonPriceIncrement.Size = new System.Drawing.Size( 98, 17 );
			this.radioButtonPriceIncrement.TabIndex = 18;
			this.radioButtonPriceIncrement.TabStop = true;
			this.radioButtonPriceIncrement.Text = "Price Increment";
			this.radioButtonPriceIncrement.UseVisualStyleBackColor = true;
			// 
			// textBoxPriceIncrement
			// 
			this.textBoxPriceIncrement.Location = new System.Drawing.Point( 26, 55 );
			this.textBoxPriceIncrement.Name = "textBoxPriceIncrement";
			this.textBoxPriceIncrement.Size = new System.Drawing.Size( 68, 20 );
			this.textBoxPriceIncrement.TabIndex = 17;
			// 
			// radioButtonPriceMultiplier
			// 
			this.radioButtonPriceMultiplier.AutoSize = true;
			this.radioButtonPriceMultiplier.Location = new System.Drawing.Point( 118, 35 );
			this.radioButtonPriceMultiplier.Name = "radioButtonPriceMultiplier";
			this.radioButtonPriceMultiplier.Size = new System.Drawing.Size( 92, 17 );
			this.radioButtonPriceMultiplier.TabIndex = 19;
			this.radioButtonPriceMultiplier.TabStop = true;
			this.radioButtonPriceMultiplier.Text = "Price Multiplier";
			this.radioButtonPriceMultiplier.UseVisualStyleBackColor = true;
			// 
			// label4
			// 
		...
		private System.Windows.Forms.RadioButton radioButtonPriceIncrement;
		private System.Windows.Forms.TextBox textBoxPriceIncrement;
		private System.Windows.Forms.RadioButton radioButtonPriceMultiplier;
