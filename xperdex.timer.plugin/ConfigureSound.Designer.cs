namespace xperdex.timer.plugin
{
	partial class ConfigureSound
	{
		...
		private void InitializeComponent()
		{
			...
			// button1
			// 
			this.button1.Location = new System.Drawing.Point( 318, 202 );
			...
			this.Name = "ConfigureSound";
			this.Text = "ConfigureSound";
			this.Load += new System.EventHandler( this.ConfigureSound_Load );
