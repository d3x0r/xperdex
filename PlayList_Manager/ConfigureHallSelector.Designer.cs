...
{
	partial class ConfigureHallSelector
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.Name = "ConfigureHallSelector";
			this.Text = "ConfigureHallSelector";
			this.Load += new System.EventHandler( this.ConfigureHallSelector_Load );
