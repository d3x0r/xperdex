        ...
        private void OKButton_Click(object sender, System.EventArgs e)
        {
			try
			{
				...
				ManagementScope scope = new ManagementScope(
					"\\\\192.168.1.5\\root\\CIMV2", connection );
				scope.Connect();
...
//}
		public RemoteConnectivity()
		{
			...
			*/
			return;
			MyQuerySample mqs = new MyQuerySample();
			mqs.ShowDialog();
			...
			ManagementScope scope =
				new ManagementScope(
					"\\\\192.168.1.5\\root\\cimv2" );
			scope.Options.Username = "jungle/Administrator";
			scope.Options.Password = "waterrat";
			try
			{
				scope.Connect();
			}
