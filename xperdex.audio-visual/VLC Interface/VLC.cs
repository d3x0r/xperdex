...
namespace LiquidVideo
{
    public class VLC
    {
        ...
        public VLC()
        {
            vlcInstallDirectory = Path.GetDirectoryName(Assembly.GetExecutingAssembly().CodeBase).Substring(6);
            if (iVLC != -1)
                return;
            ...
            try
            {
                ...
                string[] initOptions = {vlcInstallDirectory,
                                           ...
                                           "--snapshot-format=png",
                                           "--sub-filter=marq",
                                           "--marq-marquee=Bill SerGio, The Infomercial King",
                                           "--marq-opacity=255",
				};
            ...
            {
                throw new Exception("Could not find libvlc");
            }
        }
